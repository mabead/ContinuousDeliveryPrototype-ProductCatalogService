...
namespace ProductCatalog.LoadTester.Generated
{
    ...
    public partial interface IAPIV1 : IDisposable
    {
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse> ApiProductsByIdGetWithHttpMessagesAsync(string id, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
